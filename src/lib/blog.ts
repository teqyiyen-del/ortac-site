...
/* Hafif parçalar blogTemel.ts'te (tarayıcı paketine giriyorlar); burada
   yeniden dışa aktarılıyor ki sunucu tarafındaki import'lar değişmesin. */
export {
  CATEGORY_ORDER,
  DEMO_POST,
  GUIDE_CATEGORY,
...
export type { BlogCategory, BlogSlug, ReservedBlogSlug } from "@/lib/blogTemel";
