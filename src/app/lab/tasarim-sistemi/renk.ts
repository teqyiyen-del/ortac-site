...
export const RENK_GRUPLAR: { baslik: string; aciklama: string; satirlar: RenkSatir[] }[] = [
  ...
  },
  {
    ...
    satirlar: [
      ...
      {
        token: "--on-dark-2",
        deger: "rgba(255,255,255,.72)",
        rol: "açıklama, hero cümlesi",
        simdi: ".66 · .7 · .76 · #a6a6a6 · #9a9a9a · #9aa0aa",
        kontrast: "10,8",
        koyu: true,
        yazi: true,
      },
      {
        token: "--on-dark-3",
        deger: "rgba(255,255,255,.55)",
        rol: "not, etiket, yasal satır",
        simdi: ".4 (3,8:1) · .42 · .45 · .5 · .58 · #8a8a8a · #7d7d7d · #9c9c9c",
        kontrast: "6,5",
        koyu: true,
        yazi: true,
      },
