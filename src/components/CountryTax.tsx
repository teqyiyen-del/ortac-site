    ...
    <section id="vergi" className="sec-pad" style={{ background: "var(--white)" }}>
      <div className="container-o">
        ...
        {/* ---------- yayımlanmış başlıklar: YALNIZCA aracı olmayan ülkede ----------
            ...
            olduğu yerde durdu. */}
        {/* ---------- kâr–oran eğrisi: oran kâra göre kademeliyse ----------
            23.09.2026 · İKİNCİ HÂL. İlk hâl üç mavi kutuluk bir bant ve altında
            dört rakam kartıydı; Burak: "her şeyi neredeyse maviye boyamışsın
            … bir sürü box, bir sürü sayı … görsellik sokabilirsin." Şimdi tek
