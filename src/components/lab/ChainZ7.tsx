...
/* ============================================================================
   ...
   TARİHÇE UYARISI: aşağıda anılan Z4 (ve Z1–Z3, Z5, Z6) müşteri isteğiyle
   SİLİNDİ — bileşenleri de lab-z1…lab-z6.css de artık yok. Bu adlar depoda
   karşılığı olmayan tasarım kararlarına atıf; /lab/zincir'de kalan Z8 · Z7.
